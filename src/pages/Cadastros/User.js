  ...
  return (
    <div className='container-user-page'>
      ...
      <Box sx={{ '& > :not(style)': {m: '45%' } }}>
        <Link to={"/cadastros/user/criar"} style={{ textDecoration: 'none' }}>       
                  ...
                  .map((user) => {
                    return (
                      < TableRow hover role="checkbox" tabIndex={-1} key={user.id}>                                                
                          ...
                          < TableCell align="center">{user.unidade.bloco}</ TableCell> 
                          < TableCell align="center">{user.unidade.numero}</ TableCell>                           
                          < TableCell align="center" ><DeleteIcon sx={{ color: red[500], my: 2 }} onClick={() => handleRemove(user.id)}/></TableCell>                  
                      </TableRow>
                    );
                  })}
              </TableBody>
